...
<body>
        @extends('Left_Sidebar')
            ...
            @section('right-section')
                    ...
                    <h1 class="text-3xl font-bold mb-2" id="page-title">All Pets</h1>
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <form action="{{ route('pets.search') }}" method="POST" class="flex items-center">
                            @csrf
                            <input type="text" name="key" placeholder="Search pets..."
                                class="rounded-l-lg p-2 border-t border-b border-l text-gray-50 border-gray-700 bg-gray-900"
                                >
                            <button type="submit"
                                    class="px-4 py-2 rounded-r-lg bg-blue-500 text-white hover:bg-blue-600 border-blue-500">
                                Search
                            </button>
                        </form>
                    </div>
